  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'creative-gradient': 'linear-gradient(135deg, #8B5CF6 0%, #EC4899 25%, #3B82F6 50%, #F97316 75%, #10B981 100%)',
      ...
      boxShadow: {
        'creative': '0 10px 25px -5px rgba(139, 92, 246, 0.3), 0 20px 40px -10px rgba(236, 72, 153, 0.2)',
