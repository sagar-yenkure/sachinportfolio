...
import { Briefcase, Calendar, MapPin, Star, Zap } from 'lucide-react';
import CTA from './CTA';

export default function ExperienceSection() {
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-slate-50 via-white to-purple-50/30 relative overflow-hidden">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.skills.map((skill, i) => (
                      <span
                        key={i}
                        className={`px-3 py-2 bg-gradient-to-r text-purple-500 rounded-full text-xs font-medium shadow-md hover:shadow-lg transition-shadow duration-300`}
                      >
                        {skill}
                      </span>
                    ))}
